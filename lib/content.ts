...
export const defaultContent: PageContent = {
  ...
  productsTitle: "Celé Red Hat portfolio se slevou 15 %",
  products: [
  ...
  sovereigntyCTAText: "Regulatorní tlak roste. Vzdělávejte tým na tématech, která jsou dnes strategickou prioritou — se slevou 15 % v rámci Success Weeku.",
  contacts: [
